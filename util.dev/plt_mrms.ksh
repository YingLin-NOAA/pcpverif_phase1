#!/bin/ksh 
set -x
# plot a 24h (12Z-12Z) total of MRMS
#
day=$1
...
'draw title MRMS 24h pcp ending 12Z ${day}'
'printim mrms.${day}12.24h.gif gif x480 y425 white'
'quit'
EOF2

gribmap -i mrms.ctl

grads -blc "run pltgrads_mrms.gs"
exit
